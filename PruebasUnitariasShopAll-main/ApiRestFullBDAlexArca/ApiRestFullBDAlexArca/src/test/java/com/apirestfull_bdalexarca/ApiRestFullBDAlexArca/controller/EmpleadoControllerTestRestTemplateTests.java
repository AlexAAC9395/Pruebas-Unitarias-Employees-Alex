...
//@ContextConfiguration(classes = EmpleadoControllerTestRestTemplateTests.class)
...
public class EmpleadoControllerTestRestTemplateTests {
    ...
    void testGuardarEmpleado(){
        ...
        assertEquals("Alejandro",empleadoCreado.getNombre());
        assertEquals("Arroyo",empleado.getApellido());
        assertEquals("a1@gmail.com",empleadoCreado.getEmail());
    }
    ...
    void testListarEmpleados(){
        ...
        assertEquals("Arroyo",empleados.get(0).getApellido());
        assertEquals("a1@gmail.com",empleados.get(0).getEmail());
    }
    ...
    void testObtenerEmpleado(){
        ...
        assertEquals("Alejandro",empleado.getNombre());
        assertEquals("Arroyo",empleado.getApellido());
        assertEquals("a1@gmail.com",empleado.getEmail());
    }
